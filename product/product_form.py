...
class ProductForm(forms.Form):
    ...
    same_day_delivary_price = forms.CharField(widget=forms.NumberInput(attrs={'class': 'form-control', 'id': 'inputAddress', 'placeholder': 'Price', 'min': 0}))
    ...
    next_day_delivary_price = forms.CharField(widget=forms.NumberInput(attrs={'class': 'form-control', 'id': 'inputAddress', 'placeholder': 'Price', 'min': 0}))
    ...
    customize_delivary_day = forms.CharField(widget=forms.NumberInput(attrs={'class': 'form-control', 'id': 'inputAddress', 'placeholder': 'Add Day', 'min': 0}))
    customize_delivary_price = forms.CharField(widget=forms.NumberInput(attrs={'class': 'form-control', 'id': 'inputAddress', 'placeholder': 'Price', 'min': 0}))
